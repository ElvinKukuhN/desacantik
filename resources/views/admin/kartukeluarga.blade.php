               ...
               <thead>
                <tr>
                    ...
                    <tbody>
                        ...
                        <td>
                            <a href="{{ url('/detailruta'.$w->id) }}" class="text-success "><i class="dripicons-document-new"></i> detail  </a> |  
                            <a href="{{ url('/editruta'.$w->id) }}" class="text-primary "><i class=" dripicons-document-edit "></i> edit  </a>  |
                            <a href="{{ url('/delete/'.$w->id) }}" class="text-danger "><i class="dripicons-trash"></i> hapus  </a> |
                        </td>                                                   
